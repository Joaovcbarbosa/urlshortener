        ...
        for i in range(6):
            for j in range(10):
                ...
                if i == 0:         
                    ...
                    export_results(instance, 'BRKGA', j, result)
