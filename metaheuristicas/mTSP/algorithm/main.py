...
def main():
    ...
    for instance in list_of_instance:
        for j in range(rounds):            
            ...
            if option == '3':
                MH = 'ILS'
                result = ILS(instance, betta_min=1, betta_max=10, ILS_max=150, print_execution=print_execution)   
            if option == '4':
                MH = 'VNS'
            ...
            if option == '6':
                MH = 'BRKGA'
                result = BRKGA(instance, BRKGAMax=1000, p=610, pe_min=10, pe_max=30, rhoe_min=55, rhoe_max=80, pm_min=1, pm_max=7, print_execution=print_execution)
            else:
                exit 
